...
namespace BE_502ag
{
    public class BE_Factura_502ag
    {
        ...
        public BE_Factura_502ag(int pCodFactura_502ag, int pCodCombustible_502ag, string pNombreCombustible_502ag)
        {
        ...
        public BE_Factura_502ag(int pCodFactura_502ag, int pCodCombustible_502ag, bool pIsFacturado_502ag, int pEstadoFactura_502ag, DateTime pFecha_502ag, TimeSpan pHora_502ag, string pNombreCombustible_502ag)
        {
            CodFactura_502ag = pCodFactura_502ag;
            CodCombustible_502ag = pCodCombustible_502ag;
            IsFacturado_502ag = pIsFacturado_502ag;
        ...
        public BE_Factura_502ag(int pCodFactura_502ag, int pCodCombustible_502ag, bool pIsFacturado_502ag, int pEstadoFactura_502ag, DateTime pFecha_502ag, TimeSpan pHora_502ag, decimal pMonto_502ag, decimal pCantCargada_502ag, string pNombreCombustible_502ag)
        {
            CodFactura_502ag = pCodFactura_502ag;
            CodCombustible_502ag = pCodCombustible_502ag;
            IsFacturado_502ag = pIsFacturado_502ag;
        ...
        public BE_Factura_502ag(int pCodFactura_502ag, int pCodCombustible_502ag, bool pIsFacturado_502ag, int pEstadoFactura_502ag, DateTime pFecha_502ag, TimeSpan pHora_502ag, decimal pMonto_502ag, decimal pCantCargada_502ag, string pDNICliente_502ag, string pNombreCliente_502ag, string pApellidoCliente_502ag, string pNombreCombustible_502ag)
        {
            CodFactura_502ag = pCodFactura_502ag;
            CodCombustible_502ag = pCodCombustible_502ag;
            IsFacturado_502ag = pIsFacturado_502ag;
