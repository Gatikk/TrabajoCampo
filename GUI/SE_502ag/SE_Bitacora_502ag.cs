...
namespace SE_502ag
{
    public class SE_Bitacora_502ag
    {
        ...
        public SE_Bitacora_502ag(int pCodBitacora_502ag, string pNombreUsuario_502ag, DateTime pFecha_502ag, TimeSpan pHora_502ag, string pModulo_502ag, string pDescripcion_502ag, int pCriticidad_502ag)
        {
