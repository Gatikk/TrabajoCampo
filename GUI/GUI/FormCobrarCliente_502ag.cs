    ...
    public partial class FormCobrarCliente_502ag : Form
    {
        ...
        private void buttonRealizarPago_502ag_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string numTarjeta_502ag = tBNumero_502ag.Text;
                string codSeguridad_502ag = tBCodigoSeguridad_502ag.Text;
                string fechaCad_502ag = tBFechaCaducidad_502ag.Text;
